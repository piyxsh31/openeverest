...
func (k *Kubernetes) ListMonitoringConfigsV2(ctx context.Context, opts ...ctrlclient.ListOption) (*monitoringv1alpha1.MonitoringConfigList, error) {
	result := &monitoringv1alpha1.MonitoringConfigList{}
...
func (k *Kubernetes) GetMonitoringConfigV2(ctx context.Context, key ctrlclient.ObjectKey) (*monitoringv1alpha1.MonitoringConfig, error) {
	result := &monitoringv1alpha1.MonitoringConfig{}
...
func (k *Kubernetes) GetMonitoringConfigMetaV2(ctx context.Context, key ctrlclient.ObjectKey) (*metav1.PartialObjectMetadata, error) {
	...
	objMeta.SetGroupVersionKind(monitoringv1alpha1.GroupVersion.WithKind("MonitoringConfig"))
...
func (k *Kubernetes) CreateMonitoringConfigV2(ctx context.Context, config *monitoringv1alpha1.MonitoringConfig) (*monitoringv1alpha1.MonitoringConfig, error) {
...
func (k *Kubernetes) UpdateMonitoringConfigV2(ctx context.Context, config *monitoringv1alpha1.MonitoringConfig) (*monitoringv1alpha1.MonitoringConfig, error) {
...
func (k *Kubernetes) DeleteMonitoringConfigV2(ctx context.Context, obj *monitoringv1alpha1.MonitoringConfig) error {
