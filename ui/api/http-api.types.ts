    ...
    schemas: {
        ...
        Instance: {
            ...
            status?: {
                ...
                /** @description ConnectionURL is the URL to connect to the database cluster. */
                connectionURL?: string;
                /**
                 * @description CredentialSecretRef is a reference to the secret containing the credentials.
