...
func (h *rbacHandler) ListBackupClasses(ctx context.Context) (*v1alpha1.BackupClassList, error) {
...
func (h *rbacHandler) GetBackupClass(ctx context.Context, name string) (*v1alpha1.BackupClass, error) {
	// Add RBAC checks here if needed in the future
