...
func (in *BackupClassSpec) DeepCopyInto(out *BackupClassSpec) {
	*out = *in
	...
	if in.RestoreJobSpec != nil {
		in, out := &in.RestoreJobSpec, &out.RestoreJobSpec
		*out = new(BackupJobSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.RestoreCleanupJobSpec != nil {
		in, out := &in.RestoreCleanupJobSpec, &out.RestoreCleanupJobSpec
		*out = new(BackupJobSpec)
		(*in).DeepCopyInto(*out)
	}
	in.RestoreConfig.DeepCopyInto(&out.RestoreConfig)
	if in.RestorePermissions != nil {
		in, out := &in.RestorePermissions, &out.RestorePermissions
		*out = make([]rbacv1.PolicyRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.RestoreClusterPermissions != nil {
		in, out := &in.RestoreClusterPermissions, &out.RestoreClusterPermissions
		*out = make([]rbacv1.PolicyRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
